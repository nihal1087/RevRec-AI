...
const SOFT_CODES = ["INSUFFICIENT_FUNDS", "EXCEEDS_BALANCE", "ACCOUNT_LOW_BALANCE"];
const NETWORK_CODES = ["UPI_SWITCH_DOWN", "GATEWAY_TIMEOUT", "BANK_SWITCH_OFFLINE", "NPIC_TIMEOUT"];
const INTENT_CODES = ["OTP_TIMED_OUT", "USER_DROPPED_OUT", "AUTH_CANCELLED", "UPI_APP_CLOSED"];
